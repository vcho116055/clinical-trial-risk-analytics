...
MODEL_RESULTS_PATH = REPORTS_DIR / 'model_results_larger.csv'

LOGISTIC_FEATURE_IMPORTANCE_PATH = (
    REPORTS_DIR / 'logistic_regression_feature_importance_larger.csv'
)

RANDOM_FOREST_FEATURE_IMPORTANCE_PATH = (
    REPORTS_DIR / 'random_forest_feature_importance_larger.csv'
)

XGBOOST_FEATURE_IMPORTANCE_PATH = (
    REPORTS_DIR / 'xgboost_feature_importance_larger.csv'
)
